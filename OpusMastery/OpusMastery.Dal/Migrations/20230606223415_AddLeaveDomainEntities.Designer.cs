...
namespace OpusMastery.Dal.Migrations
{
    ...
    [Migration("20230606223415_AddLeaveDomainEntities")]
    partial class AddLeaveDomainEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OpusMastery.Dal.Models.LeaveApplication", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("OpusMastery.Dal.Models.LeaveApplicationStatus", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("LeaveApplicationStatuses");
                });

            modelBuilder.Entity("OpusMastery.Dal.Models.LeaveApplicationType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("OpusMastery.Dal.Models.LeaveApplication", b =>
                {
                    b.HasOne("OpusMastery.Dal.Models.Employee", "Employee")
                        .WithMany()
                        .HasForeignKey("EmployeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("OpusMastery.Dal.Models.LeaveApplicationStatus", "Status")
                        .WithMany("LeaveApplications")
                        .HasForeignKey("StatusId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("OpusMastery.Dal.Models.LeaveApplicationType", "Type")
                        .WithMany("LeaveApplications")
