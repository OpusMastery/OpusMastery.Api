...
namespace OpusMastery.Dal.Migrations
{
    ...
    [Migration("20230530211823_ChangeTablesStructureAndAddRefreshTokenAndVerificationCodeTables")]
    partial class ChangeTablesStructureAndAddRefreshTokenAndVerificationCodeTables
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OpusMastery.Dal.Models.Identity.SystemUserRefreshToken", b =>
                {
                    b.HasOne("OpusMastery.Dal.Models.Identity.SystemUser", "User")
                        ...
                        .HasForeignKey("OpusMastery.Dal.Models.Identity.SystemUserRefreshToken", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
